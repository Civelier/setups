...
-D PYTHON_INCLUDE=/usr/include/python3.8/ \
-D PYTHON_LIBRARY=/usr/lib/libpython3.8.so.1.0 \
-D PYTHON_PACKAGES_PATH=/usr/local/lib/python3.8/site-packages/ \
-D PYTHON_NUMPY_INCLUDE_DIR=/usr/local/lib/python3/dist-packages/numpy/core/include ..
